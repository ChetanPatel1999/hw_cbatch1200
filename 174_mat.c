...
void displayleft_digonal(int r, int c, int mat[r][c])
{
    int i, j;
    for (i = 0; i < r; i++)
    {
...
void displayleft_digonal1(int r, int c, int mat[r][c])
{
    int i, j;
    for (i = 0; i < r; i++)
    {
...
int sum_left_digonal1(int r, int c, int mat[r][c])
{
    int i, j, sum = 0;
    for (i = 0; i < r; i++)
    {
...
void main()
{
    ...
    if (r == c)
    {
        printf("display left digonal : \n");
        displayleft_digonal1(r, c, mat);
        printf("sum of left digonal element :%d\n", sum_left_digonal1(r, c, mat));
    }
    else
    {
